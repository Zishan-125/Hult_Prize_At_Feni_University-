...
1. **Client Tier**: Modular UI with reusable components  
2. **API Tier**: RESTful services with middleware security  
3. **Data Tier**: Optimized relational database schema  
...
```bash
git clone https://github.com/Zishan-125/Hult_Prize_At_Feni_University-.git
```
...
```bash
cd Hult_Prize_At_Feni_University-
